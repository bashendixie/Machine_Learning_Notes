...
<table width="1033" style="font-size: 0.8em;">
	<tbody>
		<tr>
			<td>
				<a href="https://github.com/lqhou/TensorFlow2.0-Book" target="_balnk">TensorFlow从零开始学</a>
			</td>
			<td>
				<a href="https://github.com/hadrienj/deepLearningBook-Notes" target="_balnk">DL Book</a>
			</td>
			<td>
